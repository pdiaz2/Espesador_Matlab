 ...
 *
 * Code generation for function '_coder_predictRF_Y2_api'
 *
 */
...
static const mxArray *emlrt_marshallOut(const emxArray_real_T *u)
{
  const mxArray *y;
  const mxArray *m2;
  static const int32_T iv482[1] = { 0 };

  y = NULL;
  m2 = emlrtCreateNumericArray(1, iv482, mxDOUBLE_CLASS, mxREAL);
...
void predictRF_Y2_api(predictRF_Y2StackData *SD, const mxArray * const prhs[3],
                      const mxArray *plhs[1])
{
  ...
  predictRF_Y2(SD, &st, X, numTrees, numPredictors, Y);
...
/* End of code generation (_coder_predictRF_Y2_api.c) */
