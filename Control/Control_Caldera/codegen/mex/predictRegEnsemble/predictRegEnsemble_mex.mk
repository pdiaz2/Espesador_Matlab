START_DIR = C:\Users\pablo\DOCUME~1\MATLAB\Magister\Pablo\Git\ESPESA~1\Control\CONTRO~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017a
MAKEFILE = predictRegEnsemble_mex.mk

include predictRegEnsemble_mex.mki


SRC_FILES =  \
	predictRegEnsemble_mexutil.c \
	predictRegEnsemble_data.c \
	...
	predictRegEnsemble_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = predictRegEnsemble_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\predictRegEnsemble"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRegEnsemble/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRegEnsemble/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRegEnsemble/%.cu
	$(CC) $(CCFLAGS) "$<"
