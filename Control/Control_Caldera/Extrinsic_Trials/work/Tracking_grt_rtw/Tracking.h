...
#define Tracking_rtModel               RT_MODEL_Tracking_T
...
typedef struct {
  real_T x_est[6];                     /* '<Root>/Tracking' */
  real_T p_est[36];                    /* '<Root>/Tracking' */
  int32_T SFunction_DIMS2[2];          /* '<Root>/Tracking' */
} DW_Tracking_T;
...
#define rtB                            Tracking_B
#define BlockIO                        B_Tracking_T
#define rtU                            Tracking_U
#define ExternalInputs                 ExtU_Tracking_T
#define rtY                            Tracking_Y
#define ExternalOutputs                ExtY_Tracking_T
#define rtDWork                        Tracking_DW
#define D_Work                         DW_Tracking_T
...
/* External inputs (root inport signals with auto storage) */
extern ExtU_Tracking_T Tracking_U;

/* External inputs size (variable-sizing root inport signals with auto storage) */
extern ExtUSize_Tracking_T Tracking_USize;

/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_Tracking_T Tracking_Y;

/* External outputs size (variable-sizing root outport signals with auto storage) */
extern ExtYSize_Tracking_T Tracking_YSize;

/*====================*
 * External functions *
 *====================*/
extern Tracking_rtModel *Tracking(void);
 ...
 *
 * hilite_system('ex_kalman33/Tracking')    - opens subsystem ex_kalman33/Tracking
 * hilite_system('ex_kalman33/Tracking/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'ex_kalman33'
 * '<S1>'   : 'ex_kalman33/Tracking'
 */
