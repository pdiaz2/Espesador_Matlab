...
## Generated on : Tue May 01 22:38:20 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Tracking.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Tracking.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Tracking_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Tracking -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Tracking_grt_rtw/Tracking.c $(START_DIR)/Tracking_grt_rtw/rtGetInf.c $(START_DIR)/Tracking_grt_rtw/rtGetNaN.c $(START_DIR)/Tracking_grt_rtw/rt_nonfinite.c rt_logging.c rt_sim.c $(MATLAB_ROOT)/rtw/c/grt/classic_main.c
...
OBJS = Tracking.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj rt_sim.obj classic_main.obj
...
%.obj : $(START_DIR)/Tracking_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
