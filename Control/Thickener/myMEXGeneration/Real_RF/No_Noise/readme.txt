...
2. Installing the coco Package

A. Go to the directory that contains the file setup.py and the subdirectory coco. If you 
...
3. Using the coco Package

The coco package is on your Python path. To import it into a Python script or session, 
   execute:
