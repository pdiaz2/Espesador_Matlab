 ...
 *
 * Code generation for function '_coder_predictRF_Y1_B100_na6_nb6_1408_api'
 *
 */
...
static emlrtRTEInfo e_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_predictRF_Y1_B100_na6_nb6_1408_api",/* fName */
  ""                                   /* pName */
};
...
static const mxArray *emlrt_marshallOut(const emxArray_real_T *u)
{
  const mxArray *y;
  const mxArray *m2;
  static const int32_T iv348[1] = { 0 };

  y = NULL;
  m2 = emlrtCreateNumericArray(1, iv348, mxDOUBLE_CLASS, mxREAL);
...
void predictRF_Y1_B100_na6_nb6_1408_api(d_predictRF_Y1_B100_na6_nb6_140 *SD,
  const mxArray * const prhs[3], const mxArray *plhs[1])
{
  emxArray_real_T *X;
  emxArray_real_T *Y;
  real_T numTrees;
  ...
  predictRF_Y1_B100_na6_nb6_1408(SD, &st, X, numTrees, numPredictors, Y);
...
/* End of code generation (_coder_predictRF_Y1_B100_na6_nb6_1408_api.c) */
