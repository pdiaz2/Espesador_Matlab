START_DIR = C:\Users\Felipe\DOCUME~1\MATLAB\PABLOD~1\Git\ESPESA~1\Control\CONTRO~2\MYMEXG~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017a
MAKEFILE = predictRF_Y2_mex.mk

include predictRF_Y2_mex.mki


SRC_FILES =  \
	predictRF_Y2_data.c \
	predictRF_Y2_initialize.c \
	predictRF_Y2_terminate.c \
	predictRF_Y2.c \
	error.c \
	CompactRegressionTree.c \
	validateattributes.c \
	_coder_predictRF_Y2_info.c \
	_coder_predictRF_Y2_api.c \
	_coder_predictRF_Y2_mex.c \
	predictRF_Y2_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = predictRF_Y2_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\predictRF_Y2"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y2/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y2/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y2/%.cu
	$(CC) $(CCFLAGS) "$<"
