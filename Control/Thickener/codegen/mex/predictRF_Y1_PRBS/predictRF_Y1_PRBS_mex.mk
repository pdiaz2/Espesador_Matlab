...
MAKEFILE = predictRF_Y1_PRBS_mex.mk

include predictRF_Y1_PRBS_mex.mki


SRC_FILES =  \
	predictRF_Y1_PRBS_data.c \
	predictRF_Y1_PRBS_initialize.c \
	predictRF_Y1_PRBS_terminate.c \
	predictRF_Y1_PRBS.c \
	error.c \
	CompactRegressionTree.c \
	validateattributes.c \
	_coder_predictRF_Y1_PRBS_info.c \
	_coder_predictRF_Y1_PRBS_api.c \
	_coder_predictRF_Y1_PRBS_mex.c \
	predictRF_Y1_PRBS_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = predictRF_Y1_PRBS_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\predictRF_Y1_PRBS"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y1_PRBS/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y1_PRBS/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y1_PRBS/%.cu
	$(CC) $(CCFLAGS) "$<"
