 ...
 *
 * Code generation for function '_coder_predictRF_Y1_PRBS_api'
 *
 */
...
static emlrtRTEInfo e_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_predictRF_Y1_PRBS_api",      /* fName */
  ""                                   /* pName */
};
...
void predictRF_Y1_PRBS_api(predictRF_Y1_PRBSStackData *SD, const mxArray * const
  prhs[3], const mxArray *plhs[1])
{
  ...
  predictRF_Y1_PRBS(SD, &st, X, numTrees, numPredictors, Y);
...
/* End of code generation (_coder_predictRF_Y1_PRBS_api.c) */
