/*
 * _coder_predictRF_Y3_PRBS_api.c
 *
 * Code generation for function '_coder_predictRF_Y3_PRBS_api'
 *
 */
...
static emlrtRTEInfo e_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_predictRF_Y3_PRBS_api",      /* fName */
  ""                                   /* pName */
};
...
static const mxArray *emlrt_marshallOut(const emxArray_real_T *u)
{
  const mxArray *y;
  const mxArray *m2;
  static const int32_T iv408[1] = { 0 };

  y = NULL;
  m2 = emlrtCreateNumericArray(1, iv408, mxDOUBLE_CLASS, mxREAL);
...
void predictRF_Y3_PRBS_api(predictRF_Y3_PRBSStackData *SD, const mxArray * const
  prhs[3], const mxArray *plhs[1])
{
  ...
  predictRF_Y3_PRBS(SD, &st, X, numTrees, numPredictors, Y);
...
/* End of code generation (_coder_predictRF_Y3_PRBS_api.c) */
