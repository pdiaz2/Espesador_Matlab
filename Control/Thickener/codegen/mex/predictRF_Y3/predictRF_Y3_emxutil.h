/*
 * predictRF_Y3_emxutil.h
 *
 * Code generation for function 'predictRF_Y3_emxutil'
 *
 */

#ifndef PREDICTRF_Y3_EMXUTIL_H
#define PREDICTRF_Y3_EMXUTIL_H
...
/* End of code generation (predictRF_Y3_emxutil.h) */
