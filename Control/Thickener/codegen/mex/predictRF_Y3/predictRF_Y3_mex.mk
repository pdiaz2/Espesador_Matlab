...
SRC_FILES =  \
	...
	predictRF_Y3_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = predictRF_Y3_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\predictRF_Y3"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y3/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y3/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y3/%.cu
	$(CC) $(CCFLAGS) "$<"
