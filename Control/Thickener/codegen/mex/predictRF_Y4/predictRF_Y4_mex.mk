...
MAKEFILE = predictRF_Y4_mex.mk

include predictRF_Y4_mex.mki
...
SRC_FILES =  \
	...
	_coder_predictRF_Y4_info.c \
	_coder_predictRF_Y4_api.c \
	_coder_predictRF_Y4_mex.c \
	predictRF_Y4_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = predictRF_Y4_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\predictRF_Y4"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y4/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y4/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y4/%.cu
	$(CC) $(CCFLAGS) "$<"
