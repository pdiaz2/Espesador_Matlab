/*
 * predictRF_Y3_PRBS_emxutil.h
 *
 * Code generation for function 'predictRF_Y3_PRBS_emxutil'
 *
 */

#ifndef PREDICTRF_Y3_PRBS_EMXUTIL_H
#define PREDICTRF_Y3_PRBS_EMXUTIL_H
...
/* End of code generation (predictRF_Y3_PRBS_emxutil.h) */
