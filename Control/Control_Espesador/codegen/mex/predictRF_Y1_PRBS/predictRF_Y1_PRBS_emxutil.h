/*
 * predictRF_Y1_PRBS_emxutil.h
 *
 * Code generation for function 'predictRF_Y1_PRBS_emxutil'
 *
 */

#ifndef PREDICTRF_Y1_PRBS_EMXUTIL_H
#define PREDICTRF_Y1_PRBS_EMXUTIL_H
...
/* End of code generation (predictRF_Y1_PRBS_emxutil.h) */
