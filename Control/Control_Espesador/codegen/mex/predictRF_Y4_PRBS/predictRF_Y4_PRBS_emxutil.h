/*
 * predictRF_Y4_PRBS_emxutil.h
 *
 * Code generation for function 'predictRF_Y4_PRBS_emxutil'
 *
 */

#ifndef PREDICTRF_Y4_PRBS_EMXUTIL_H
#define PREDICTRF_Y4_PRBS_EMXUTIL_H
...
/* End of code generation (predictRF_Y4_PRBS_emxutil.h) */
