...
MAKEFILE = predictRF_Y1_mex.mk

include predictRF_Y1_mex.mki
...
SRC_FILES =  \
	...
	_coder_predictRF_Y1_info.c \
	_coder_predictRF_Y1_api.c \
	_coder_predictRF_Y1_mex.c \
	predictRF_Y1_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = predictRF_Y1_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\predictRF_Y1"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y1/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y1/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\predictRF_Y1/%.cu
	$(CC) $(CCFLAGS) "$<"
