 ...
 *
 * Code generation for function '_coder_predictRF_Y4_api'
 *
 */
...
static const mxArray *emlrt_marshallOut(const emxArray_real_T *u)
{
  const mxArray *y;
  const mxArray *m2;
  static const int32_T iv344[1] = { 0 };

  y = NULL;
  m2 = emlrtCreateNumericArray(1, iv344, mxDOUBLE_CLASS, mxREAL);
...
void predictRF_Y4_api(predictRF_Y4StackData *SD, const mxArray * const prhs[3],
                      const mxArray *plhs[1])
{
  ...
  predictRF_Y4(SD, &st, X, numTrees, numPredictors, Y);
...
/* End of code generation (_coder_predictRF_Y4_api.c) */
