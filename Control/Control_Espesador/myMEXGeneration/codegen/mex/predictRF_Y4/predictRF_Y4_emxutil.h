/*
 * predictRF_Y4_emxutil.h
 *
 * Code generation for function 'predictRF_Y4_emxutil'
 *
 */

#ifndef PREDICTRF_Y4_EMXUTIL_H
#define PREDICTRF_Y4_EMXUTIL_H
...
/* End of code generation (predictRF_Y4_emxutil.h) */
