...
if generateOne
    mOrder.nb = mlParamsStruct.NB(nbSpecified);
    mOrder.na = mlParamsStruct.NA(naSpecified);
    mOrder.nc = mlParamsStruct.NC(ncSpecified);
    mOrder.nk = mlParamsStruct.NK(nkSpecified);
