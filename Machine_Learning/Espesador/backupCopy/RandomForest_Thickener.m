...
for delayUCases = 1:backshiftCasesU%1:backshiftCasesU
    ...
    for delayYCases = 1:backshiftCasesY%1:backshiftCasesY
        ...
        [IOData,garbage] = Prepare_IO_Data(numInputs,numOutputs,tau_R,UPastValues,YPastValues,...
...
%                 close all;
        ...
        % Prepare IO Data for model building
        [IOData,delayMaxInTime] = Prepare_IO_Data(numInputs,numOutputs,tau_R,UPastValues,YPastValues,...
