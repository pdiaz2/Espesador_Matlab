    ...
    case 'RF'
        for cv = 1:controlParamsStruct.dimsSystem(1)
            ML_Results.Output(cv).Performance(casesArray(1),casesArray(2),casesArray(3)).MSE = ...
                                                                        resultsIter(cv).MSE;
            ML_Results.Output(cv).Performance(casesArray(1),casesArray(2),casesArray(3)).NMSE = ...
                                                                        resultsIter(cv).NMSE;
%             ML_Results.Output(cv).Performance(casesArray(1),casesArray(2),casesArray(3)).DelayGen = ...
%                                                                         resultsIter(cv).DelayGen;
            ML_Results.Output(cv).Performance(casesArray(1),casesArray(2),casesArray(3)).RNMSE = ...
                                                                        resultsIter(cv).RNMSE;
            ML_Results.Output(cv).Performance(casesArray(1),casesArray(2),casesArray(3)).BFR = ...
                                                                        resultsIter(cv).BFR;
            ML_Results.Output(cv).Performance(casesArray(1),casesArray(2),casesArray(3)).FPE = ...
                                                                        resultsIter(cv).FPE;
    ...
    case 'ARMAX'
        for cv = 1:controlParamsStruct.dimsSystem(1)
            ML_Results.Output(cv).Performance(casesArray(1),casesArray(2),casesArray(3),...
